---
title: 'Draft Report: C Conduit Statistical Overview'
...
```{r deployments}
deploy = dbGetQuery(db_connection, "SELECT s.site_name, d.deploy_key, d.serial_number, d.start_dt, d.end_dt, d.active FROM deploy_info d INNER JOIN sites s USING (site_id) WHERE s.site_name = \'C (Deep)\';")
